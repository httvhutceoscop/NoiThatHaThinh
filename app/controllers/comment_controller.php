...
class CommentController extends AppController {
  ...
  function getAlbum(){
	...
	function submenuproducthome(){
		return $this->Catproduct-> find('all',array('conditions'=>array('Catproduct.status'=>1,'Catproduct.home '=>1),'order'=>'Catproduct.order DESC'));
	}
	...
	return $this->Product->find('all',array('conditions'=>array('Product.catproduct_parent_id'=>30),'order'=>'Product.id DESC','limit'=>15));	
	}
	function sanphammoi(){
