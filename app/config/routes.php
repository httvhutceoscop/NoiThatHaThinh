 ...
 */  
	...
	Router::connect('/index.html', array('controller' => 'home', 'action' => 'index')); 
    Router::connect('/tin-tuc', array('controller' => 'news', 'action' => 'index'));  
    Router::connect('/danh-sanh-tin/*', array('controller' => 'news', 'action' => 'listnews'));  
    ...
    Router::connect('/chi-tiet-tin/*', array('controller' => 'news', 'action' => 'view'));
	Router::connect('/tin/*', array('controller' => 'news', 'action' => 'view'));
	...
	Router::connect('/may-loc-nuoc.html', array('controller' => 'products', 'action' => 'maylocnuoc'));
	Router::connect('/binh-nuoc-nong.html', array('controller' => 'products', 'action' => 'binhnuocnong'));
	Router::connect('/san-pham-khuyen-mai.html', array('controller' => 'products', 'action' => 'sanphamkhuyenmai'));
	...
	Router::connect('/ds/*', array('controller' => 'products', 'action' => 'listproduct'));
	Router::connect('/dssp/*', array('controller' => 'products', 'action' => 'listproductchild'));
	Router::connect('/loai/*', array('controller' => 'products', 'action' => 'listproducthsx'));
	Router::connect('/mau/*', array('controller' => 'products', 'action' => 'listproducthsx'));
	Router::connect('/bando/*', array('controller' => 'products', 'action' => 'listproducthsx'));   
	Router::connect('/danh-muc-san-pham/*', array('controller' => 'products', 'action' => 'dssanpham'));
	...
	Router::connect('/sp/*', array('controller' => 'products', 'action' => 'view'));
	...
	Router::connect('/gio-hang.html', array('controller' => 'products', 'action' => 'viewshopingcart'));	
