...
class ProductsController extends AppController {
	...
	function add() {
		...
		if (!empty($this->data)) {
			...
			$data['Product']['images1'] = isset($_POST['userfile1'])?$_POST['userfile1']:'';
             
            $data['Product']['images2'] = isset($_POST['userfile2'])?$_POST['userfile2']:'';
            $data['Product']['images3'] = isset($_POST['userfile3'])?$_POST['userfile3']:'';
            $data['Product']['images4'] = isset($_POST['userfile4'])?$_POST['userfile4']:'';
		...
		$list_cat4 = $this->Material->generatetreelist(null,null,null,"");
        $this->set(compact('list_cat4'));
		
		$this->loadModel("Origin");
		$list_cat5 = $this->Origin->generatetreelist(null,null,null,"");
        $this->set(compact('list_cat5'));
		$this->loadModel("Style");
		$list_cat6 = $this->Style->generatetreelist(null,null,null,"");
        $this->set(compact('list_cat6'));
	}
	//view mot tin 
	...
	function edit($id = null) {
        ...
        $this->set(compact('gia'));
		$this->loadModel("Material");
		$list_cat4 = $this->Material->generatetreelist(null,null,null," _ ");
        $this->set(compact('list_cat4'));
		
		$this->loadModel("Origin");
		$list_cat5 = $this->Origin->generatetreelist(null,null,null," _ ");
        $this->set(compact('list_cat5'));
		
		$this->loadModel("Style");
		$list_cat6 = $this->Style->generatetreelist(null,null,null," _ ");
        $this->set(compact('list_cat6'));
	}
function processing() {
		$this->account();
