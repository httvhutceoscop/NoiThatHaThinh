        ...
        <div class="tab-content default-tab" id="tab2">
               ...
               <?php echo $form->create(null, array( 'url' => DOMAINAD.'manufacturers/edit/Catproduct.id','type' => 'post','name'=>'image')); ?>	
                ...
                <fieldset> 
					...
					<p>
                        <label>Bản đồ </label>
                      <div class="content-detail-product-content"></div>
			

			<div class="content-detail-product-content">
			<script src="http://www.google.com/jsapi?key=AIzaSyCurvTgE8ybiVDUNI0c5xagsZPuu1FaBvM"></script>
			...
			<script type="text/javascript">
					...
					function initialize() {
						if (GBrowserIsCompatible()) {
							...
							point = new GLatLng(<?php echo $edit['Manufacturer']['map_x_axis']; ?>, <?php echo $edit['Manufacturer']['map_y_axis']; ?>);
							...
							var sHTML_53463 = '<div class="bubble">'
										+ '<p class="bubble_ref"><?php echo $edit['Manufacturer']['map_information']; ?></p></div>';
