        ...
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
				...
				<tr>
                    ...
                    <td>
                    <?php echo $this->Form->input('News.keywords',array('class'=>'text-input medium-input datepicker','maxlength' => '250','style' => 'width:200px !important'));?>
                    </td>
                </tr> 
				<tr>
                   	<td width="120" class="label">Description:</td>
                    <td>
                    <?php echo $this->Form->input('News.description',array('class'=>'text-input medium-input datepicker','maxlength' => '250','style' => 'width:200px !important'));?>
                    </td>
                </tr> 
              <tr>
                    ...
                    <td>
                    <input type="radio" value="0" id="NewsStatus0" name="data[News][hotnew]"> Không
                    	&nbsp;&nbsp;&nbsp;<input type="radio" checked="checked" value="1" id="NewsStatus1" name="data[News][hotnew]"> Có
                    </td>
                </tr>
            </table>
			<div class="clear"></div>
