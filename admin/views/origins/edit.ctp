<div class="content-box">
    ...
    <div class="content-box-content">
        ...
        <div class="tab-content default-tab" id="tab2">
               ...
               <?php echo $form->create(null, array( 'url' => DOMAINAD.'origins/edit/Catproduct.id','type' => 'post','name'=>'adminForm')); ?>	
                ...
                <fieldset> 
					...
					<!--<p>
						...
						<img src="<?php echo DOMAINAD?><?php echo $edit['Origin']['images']?>" width="200"/>
					</p>
                    ...
                    <p>
                        ...
                        <?php echo $form->input('Origin.id',array('label' => '','type'=>'hidden'));?>
                        <?php echo $form->radio('Origin.status',array(0=>'Chưa Active',1=>'Đã Active'),array('legend'=>'')) ?> 
                    </p>
                    <p>
