    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
				...
				<!--
				     	<tr>
                   	<td width="120" class="label">Kích thước: </td>
                    <td>
                    <?php echo $this->Form->input('Product.kichthuoc',array('class'=>'text-input medium-input datepicker','maxlength' => '250','onchange' => 'get_alias()','id' => 'idtitle'));?>
                    </td>
                </tr>-->
...
-->
 	<tr>
                ...
                <tr>
                    ...
                    <td>
					<p id="hinhanh"> </p>
                    <?php echo $this->Form->input('Products.images',array('class'=>'text-input image-input datepicker','id' => 'xFilePath','onclick'=>"hinhanh()",'name' => 'userfile'));?>
					...
					<td>
					<p id="hinhanh1"> </p>	
                    <?php echo $this->Form->input('Products.images1',array('class'=>'text-input image-input datepicker','id' => 'xFilePath1','onclick'=>"hinhanh1()",'name' => 'userfile1'));?>
					...
					<td>
					<p id="hinhanh2"> </p>	
                    <?php echo $this->Form->input('Products.images2',array('class'=>'text-input image-input datepicker','id' => 'xFilePath2','onclick'=>"hinhanh2()",'name' => 'userfile2'));?>
					...
					<td>
					<p id="hinhanh2"> </p>	
                    <?php echo $this->Form->input('Products.images3',array('class'=>'text-input image-input datepicker','id' => 'xFilePath3','onclick'=>"hinhanh3()",'name' => 'userfile3'));?>
					...
					<td>
					<p id="hinhanh2"> </p>	
                    <?php echo $this->Form->input('Products.images4',array('class'=>'text-input image-input datepicker','id' => 'xFilePath4','onclick'=>"hinhanh4()",'name' => 'userfile4'));?>
