...
<?php echo $form->create(null, array( 'url' => DOMAINAD.'materials/search','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?> 
                ...
                <tbody>
                   <?php $i=1; foreach ($catproduct as $key =>$value){?>
                    <tr>
                        ...
                        <td><?php echo $value['Material']['char'];?></td>
                        <td><?php echo date('d-m-Y', strtotime($value['Material']['created'])); ?></td>
                        <?php if($value['Material']['status']==0){?>  
                          <td>
                             <a href="<?php echo DOMAINAD?>catproducts/edit/<?php echo $value['Material']['id'] ?>" title="Edit"><img src="<?php echo DOMAINAD?>images/icons/pencil.png" alt="Edit" /></a>
                             <a href="javascript:confirmDelete('<?php echo DOMAINAD?>catproducts/delete/<?php echo $value['Material']['id'] ?>')" title="Delete"><img src="<?php echo DOMAINAD?>images/icons/cross.png" alt="Delete" /></a> 
                             <a href="<?php echo DOMAINAD?>Catproducts/active/<?php echo $value['Material']['id'] ?>" title="Kích hoạt" class="icon-5 info-tooltip"><img src="<?php echo DOMAINAD?>images/icons/Play-icon.png" alt="Kích hoạt" /></a>
                        </td>
                        <?php } else {?> 
                          <td>
                            <!-- Icons -->
