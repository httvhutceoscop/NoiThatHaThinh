               ...
               <tr>
                ...
                <tr>
				  ...
				  <tr>
                	...
                	<td>
                    <?php  echo $this->Form->input('Catproduct.mota',array('label' => '','type'=>'textarea')).$this->TvFck->create('Catproduct.mota',array('toolbar'=>'extra','skin'=>'kama','height'=>'300px','width'=>'700px')); ?>
                    </td>
                </tr>
                <tr>
				...
				<tr>
                    ...
                    <td>
                    <input type="radio" value="0" id="CatproductStatus0" name="data[Catproduct][home]"> Không
                    	&nbsp;&nbsp;&nbsp;<input type="radio" checked="checked" value="1" id="CatproductStatus1" name="data[Catproduct][home]"> Có
                    </td>
                </tr>
                <!--<tr>
