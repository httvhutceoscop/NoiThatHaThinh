<div class="content-box">
    ...
    <div class="content-box-content">
        ...
        <div class="tab-content default-tab" id="tab2">
              ...
              <?php echo $form->create(null, array( 'url' => DOMAINAD.'styles/add','type' => 'post','name'=>'adminForm')); ?>	    
                ...
                <fieldset> 
                    ...
                    <p>
                        <label>Trạng thái</label>
                         <?php echo $form->radio('Style.status', array(0 => 'Chưa Active', 1 => 'Đã Active'), array('value' => '1','legend'=>'')); ?>
                    </p>
                    <p>
