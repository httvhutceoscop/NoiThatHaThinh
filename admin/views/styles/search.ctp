...
<?php echo $form->create(null, array( 'url' => DOMAINAD.'styles/search','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?> 
                ...
                <tbody>
                   <?php $i=1; foreach ($catproduct as $key =>$value){?>
                    <tr>
                        ...
                        <td><?php echo $value['Style']['char'];?></td>
                        <td><?php echo date('d-m-Y', strtotime($value['Style']['created'])); ?></td>
                        <?php if($value['Style']['status']==0){?>  
                          <td>
                             <a href="<?php echo DOMAINAD?>catproducts/edit/<?php echo $value['Style']['id'] ?>" title="Edit"><img src="<?php echo DOMAINAD?>images/icons/pencil.png" alt="Edit" /></a>
                             <a href="javascript:confirmDelete('<?php echo DOMAINAD?>catproducts/delete/<?php echo $value['Style']['id'] ?>')" title="Delete"><img src="<?php echo DOMAINAD?>images/icons/cross.png" alt="Delete" /></a> 
                             <a href="<?php echo DOMAINAD?>Catproducts/active/<?php echo $value['Style']['id'] ?>" title="Kích hoạt" class="icon-5 info-tooltip"><img src="<?php echo DOMAINAD?>images/icons/Play-icon.png" alt="Kích hoạt" /></a>
                        </td>
                        <?php } else {?> 
                          <td>
                            <!-- Icons -->
