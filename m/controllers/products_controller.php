...
class ProductsController extends AppController {
	...
	function listproduct($id=null) {
		...
		mysql_query("SET names utf8");       
      	$this->set('newsproducts', $this->Product->find('all',array('conditions'=>array('Product.catproduct_id'=>$id,'Product.sptieubieu'=>'1'),'limit'=>22,'order' => 'Product.id DESC')));
		 $this->paginate = array('conditions'=>array('Product.catproduct_id'=>$id),'order'=>'Product.id DESC','limit'=>22);
	      $this->set('products', $this->paginate('Product',array()));	
	...
	if(!isset($_SESSION['shopingcart'])){  $_SESSION['shopingcart']=array();};
	 ...
	 {   
		 ...
		 {			
				...
				$shopingcart[$id]['sl']=1;
				$shopingcart[$id]['price'] = $product['Product']['giakhuyenmai'];				
				$shopingcart[$id]['total']= $product['Product']['giakhuyenmai']*$shopingcart[$id]['sl'];
				$_SESSION['shopingcart']=$shopingcart;				
